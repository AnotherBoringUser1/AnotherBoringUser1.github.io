...
const CONFIG = {
  github: {
    username: 'AnotherBoringUser1', // Your GitHub org/user name. (This is the only required config)
  },
  /**
      ...
      projects: [
        {
          title: 'CNC Machining',
          description:
            'This document outlines my CNC machining projects for an FRC robot, detailing processes and outcomes.',
          imageUrl:
            'https://www.ameritoolmfg.com/wp-content/uploads/2023/03/Machining-image-1.jpg',
  ...
  seo: {
    title: 'Portfolio of Sean Tommasini',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'sean-t-minuteman',
    x: '',
    mastodon: '',
    researchGate: '',
    facebook: '',
  ...
  educations: [
    {
      institution: 'Minuteman Technical High School',
      degree: 'Engineering',
      from: '2022',
      to: '2026',
    },
